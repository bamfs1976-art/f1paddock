...
export default function LiveSyncIndicator({ state }: Props) {
  ...
  return (
    <div className="hidden md:block fixed bottom-6 left-6 z-30 bg-paper-2 border border-ink-3 px-3 py-2 overflow-hidden relative">
      ...
      <div className="relative flex items-center gap-3 font-mono text-[10px]">
        <span className="w-2 h-2 bg-green-500 rounded-full pulse-dot" aria-hidden="true" />
